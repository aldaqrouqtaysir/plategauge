...
This release-operations harness does not change the app. It checks the exact archived camera build from source `40493849af148124a45b6a6c65d9c9146c03fdb4`; never rebuild that artifact for this check. Running the HTTPS mode requires separate release authorization. The presence of this harness grants none.
...
```text
pnpm exec tsc -p ../release/camera-r5/tsconfig.json
pnpm exec playwright test --config ../release/camera-r5/playwright.live.config.ts
```
...
The inventory has strict shape `{schemaVersion:1, appSourceCommit:"40493849af148124a45b6a6c65d9c9146c03fdb4", files:[{path:"relative/POSIX",size:123,sha256:"lowercase64hex"}]}`. It contains exactly 45 sorted, unique, bounded paths. Its exact raw-byte SHA-256 is pinned to `4f187ffba720de77cc2349d1fcdbd2b29d03c131aac132006b036fc8514e57e5`. Structural validation also pins the unchanged model and frozen benchmark-evidence identities. The inventory digest must come from release approval, not a fresh download of a mutable live manifest.
