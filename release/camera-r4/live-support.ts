...
export const SOURCE_COMMIT = "1f55a7b21cf0aff395df4930d0232a0b0838361d";
export const INVENTORY_SHA256 = "42f7b26fe0b7349cec30537cf84bddc14db9cc4b90d4a26ca1ab213b2174eecb";
...
export function parseInventory(value: unknown): Inventory {
  ...
  if (top.schemaVersion !== 1 || top.appSourceCommit !== SOURCE_COMMIT
    || !Array.isArray(top.files) || top.files.length !== 45) throw new Error("Inventory is not the approved r4 camera artifact.");
