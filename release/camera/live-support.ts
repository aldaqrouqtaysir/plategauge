...
export const SOURCE_COMMIT = "ca88b440636b8028e60a1e79ae6a51b0539a37ca";
export const INVENTORY_SHA256 = "64ef462efb059e6e6778934dae22a1b8f3fe28a0731d0b71f5ecf37d25b9fc80";
...
export function parseInventory(value: unknown): Inventory {
  ...
  if (top.schemaVersion !== 1 || top.appSourceCommit !== SOURCE_COMMIT
    || !Array.isArray(top.files) || top.files.length !== 46) throw new Error("Inventory is not the approved ca88 camera artifact.");
