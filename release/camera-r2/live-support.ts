...
export const SOURCE_COMMIT = "5d67e29bf79d088e7c4a6903c6ce2c5c58a10f1a";
export const INVENTORY_SHA256 = "d885da02a49fdc54863656ff3c368b41aa8c932c2446bd3bfca6826e9de3009b";
...
export function parseInventory(value: unknown): Inventory {
  ...
  if (top.schemaVersion !== 1 || top.appSourceCommit !== SOURCE_COMMIT
    || !Array.isArray(top.files) || top.files.length !== 46) throw new Error("Inventory is not the approved r2 camera artifact.");
