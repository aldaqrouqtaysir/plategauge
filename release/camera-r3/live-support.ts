...
export const SOURCE_COMMIT = "62efadcfd342a193458036912b38b0a613bf94be";
export const INVENTORY_SHA256 = "ddf3fd89a19aa2032bec60ab16a9a52decfc59be782dc73df04d093dd6f524f3";
...
export function parseInventory(value: unknown): Inventory {
  ...
  if (top.schemaVersion !== 1 || top.appSourceCommit !== SOURCE_COMMIT
    || !Array.isArray(top.files) || top.files.length !== 45) throw new Error("Inventory is not the approved r3 camera artifact.");
