...
export const SOURCE_COMMIT = "d2fc03257e8ebfdae3923aa454fa8b3645212731";
export const INVENTORY_SHA256 = "a95a1770aaae2373887fd3bc38d8adcd8f9f856c6b02c41bd92ebec3f68c2fc8";
...
export function parseInventory(value: unknown): Inventory {
  ...
  if (top.schemaVersion !== 1 || top.appSourceCommit !== SOURCE_COMMIT
    || !Array.isArray(top.files) || top.files.length !== 45) throw new Error("Inventory is not the approved r6 camera artifact.");
