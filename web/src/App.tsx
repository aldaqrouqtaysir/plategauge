    ...
    <>
      <header className="site-header">
        ...
        <div className="release-pill">
          <span className="release-label-wide">PlateGauge v1.0.0 · benchmark and failure explorer</span>
          <span className="release-label-compact">v1.0.0 · benchmark explorer</span>
        </div>
      </header>
